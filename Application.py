...
class Guis:
    ...
    def do_register(self):
        try:
            ...
            if username == " " or password == '' or name == '' or address == '' or phone == '' or email=='':
                ...
                qry = "SELECT username from registers order by username"
                data = self.data_base.get_data(qry)  # by executing query
    ...
    # self.trvw = ttk.Treeview(self.window, style="mystyle.Treeview", columns=(1, 2, 3, 4), show="headings",
    #                          height="10")
    # self.trvw.place(x=10, y=60)
    #build with python
