...
class FetchBill:
    ...
    def fgui(self):
        ...
        self.style.configure("mystyle.Treeview.Heading", font=('Ariel', 10, 'bold'))

        self.add_tree = ttk.Treeview(self.see_dis,style="mystyle.Treeview", column=('a', 'b','o', 'c', 'd', 'e', 'f', 'g','h'), height=15)
        self.add_tree.place(x=580, y=250)
        self.add_tree['show'] = 'headings'
        self.add_tree.column('a', width=50)
        self.add_tree.column('b', width=90)
        ...
        self.back1 = Button(self.see_dis, text="Mainscreen", command=self.backbut, bg='yellow',
                            font=('Ariel', 9, 'bold'))
